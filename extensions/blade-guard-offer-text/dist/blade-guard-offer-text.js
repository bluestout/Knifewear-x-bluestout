...
${errorInfo.componentStack}`);
  ...
  // extensions/blade-guard-offer-text/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const hasBladeGuard = (_a = lineItem == null ? void 0 : lineItem.attributes) == null ? void 0 : _a.some(
      (attribute) => attribute.key === "_blade_guard" && attribute.value === "10"
    );
    if (!hasBladeGuard) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { spacing: "tight", alignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "small", appearance: "subdued", children: [
      "\u24D8 ",
      bladeGuardText
    ] }) });
  }
})();
//# sourceMappingURL=blade-guard-offer-text.js.map
